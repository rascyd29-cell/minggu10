                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Halo,</span> <span class="text-dark">Arda</span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                            </a>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo base_url() ?>kontrolkunci" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">kontrol Kunci</span></a></li>
                    </ul>

                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo base_url() ?>history" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">history</span></a></li>
                    </ul>

                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo base_url() ?>User" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">Data User</span></a></li>
                    </ul>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Portable Terrarium Terintegrasi Akuaponik <?= date('Y'); ?></span>
                </div>
            </div>
        </footer>
    </div>
