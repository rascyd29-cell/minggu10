        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <i class=""></i>&nbsp;
                    <div>
                        <a href="<?php echo base_url('/laporan/download_excel') ?>" class="btn btn-dark">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <center><?php echo anchor('laporan/rekomendasi/' . $u->id, '<button type="button" class=" fas fa-utensils btn  btn-warning">&nbsp;&nbsp;Rekomendasi</button>'); ?> </center>


                                    </td>
                                    <td>
                                        <?php echo anchor('laporan/export_pdf/' . $u->id, '<button type="button" class=" fas fa-file-pdf btn  btn-dark">&nbsp;&nbsp;PDF</button>'); ?> <br><br>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
