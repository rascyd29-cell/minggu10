                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody class="table-border-bottom-1">
                                                        ...
                                                        for ($i = 0; $i < $count; $i++) {
                                                            ...
                                                            echo '<td>' . $no++ . '</td>';
                                                            echo '<td>' . $hasilPengurutan[$i]['label'] . '</td>';
                                                            echo '<td> <a href="' . site_url('/laporan/show/' . $hasilPengurutan[$i]['label']) . '"class="btn btn-outline-info" style="text-decoration: none; padding: 2px 6px; font-size: 6px;"> <center> <i class="bx bx-show"></center></i></td>';
                                                            echo '</tr>';
                                                        }
                                                        ?>
                                                    </tbody>
